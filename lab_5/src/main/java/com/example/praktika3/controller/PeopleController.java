...
public class PeopleController {
    ...
    public  String newPeople(@RequestBody PeopleEntity people){
        if (people == null) {
            return "Ошибка: Невозможно добавить пустую запись";
        }
        peopleRepository.save(people);
        return "Новая запись о человеке добавлена";
    }
    ...
    public String getPeopleById(@PathVariable int id) {
        ...
        if (people.isEmpty()) {
            return "Человека с данным ID нет";
        }
    ...
    public String getPeopleByGender(@RequestParam String g) {
        ...
        if (peopleList.isEmpty()) {
            return "Людей с данным полом не найдено";
        }
